Cette application permet de participer à un projet de collecte de données en rapport avec la Détection automatique du Mode de Transport (DMT) à partir de données de smartphones.
